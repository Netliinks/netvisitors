...
export const customerConfig = async (dialogContainer: InterfaceElement, customerId: any): Promise<void> => {
...
`;
    ...
    const _saveButton: InterfaceElement = document.getElementById('save-config');
    const _dialog: InterfaceElement = document.getElementById('dialog-content');
    const _permitPersonalStatic: any = document.getElementById('permitPersonalStatic');
