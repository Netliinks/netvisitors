...
export class Routines {
    private readonly dialogContainer: any = document.getElementById('app-dialogs');
    private readonly entityDialogContainer: any = document.getElementById('entity-editor-container');
    private readonly content: any = document.getElementById('datatable-container');
    public searchEntity = async (tableBody:any /*, data*/) => {
    ...
    async render(offset: any, actualPage: any, search: any) {
        infoPage.offset = offset;
        infoPage.currentPage = actualPage;
        infoPage.search = search;
        this.content.innerHTML = '';
        this.content.innerHTML = tableLayout;
        const tableBody: any = document.getElementById('datatable-body');
    ...
    load(table: any, currentPage: any, data: any) {
        table.innerHTML = '';
        currentPage--;
    ...
    pagination(items: any, limitRows: any, currentPage: any) {
      const tableBody = document.getElementById('datatable-body');
      const paginationWrapper: any = document.getElementById('pagination-container');
      ...
      function setupButtons(page: any /*, items, currentPage, tableBody, limitRows*/) {
  ...
  export(){
    const exportRegisters = document.querySelectorAll('#export-entity');
      exportRegisters.forEach((exports: any) => {
          ...
          const _closeButton:any = document.getElementById('close');
          const exportButton:any = document.getElementById('export-data');
          const statusExport:any = document.getElementById('status-export');
          let onPressed = false;
          exportButton.addEventListener('click', async() => {
              if(!onPressed){
                  ...
                  const message1:any = document.getElementById("export-total");
                  const message2:any = document.getElementById("message-export");
                  const _closeButton:any = document.getElementById('cancel');
