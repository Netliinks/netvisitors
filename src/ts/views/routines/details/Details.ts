...
export class RoutineRegisters {
    ...
    private readonly siebarDialogContainer:any = document.getElementById('entity-editor-container');
    private readonly appContainer:any = document.getElementById('datatable-container');
    

        async render(offset:any, actualPage:any, search:any, countNewRegister:any, statusSearch:any){
            ...
            const viewTitle:any = document.getElementById('view-title');
        ...
        load(tableBody:any, currentPage:any, notes:any){
                ...
                `;
                    ...
                    if(i+1 <= infoPage.countNewRegister){
                        if(register?.routineState?.name == 'No cumplido'){
                            let divNewRegister:any = document.getElementById(`td-alert-${register.id}`);
                            ...
                            let timeTemp = 1000;
                            let btnAlarm:any = document.getElementById(`btnAlarm-${register.id}`);
                            let alarmIcon = async () => {
                                //audio.pause();
                                if(color == 1){
        ...
        async searchNotes(tableBody:any /*, notes: any*/){
            const search:any = document.getElementById('search');
            const btnSearch:any = document.getElementById('btnSearch');
            const statusSearch:any = document.getElementById('status-search');
        ...
        async previewNote(){
            ...
            openPreview.forEach((preview:any) => {
                let currentNoteId = preview.dataset.entityid;
                preview.addEventListener('click', () => {
                    previewBox(currentNoteId);
                });
            });
            const previewBox = async (noteId:any) => {
                const register = await getEntityData('RoutineRegister', noteId);
                renderRightSidebar(UIRightSidebar);
                const sidebarContainer:any = document.getElementById('entity-editor-container');
                const closeSidebar:any = document.getElementById('close');
        ...
        closeRightSidebar = () => {
            const closeButton:any = document.getElementById('close');
        ...
        zoom = (register:any) => {
            const picture:any = document.getElementById('register-picture');
        ...
        export = () => {
                const exportNotes:any = document.getElementById('export-entities');
