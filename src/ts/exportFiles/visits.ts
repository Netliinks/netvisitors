...
const exportVisitPdfLegacy = (ar: any, start: any, end: any) => {
    // @ts-ignore
...
export const exportVisitPdf = (visits: any[], start: any, end: any) => {
    const userCounts = visits.reduce<Record<string, number>>((counts, visit) => {
